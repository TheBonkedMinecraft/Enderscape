...
public class EnderscapeItems {
    ...
    public static final Item MUSIC_DISC_BLISS = new MusicDiscItem(0, EnderscapeSounds.MUSIC_DISC_BLISS, new FabricItemSettings().maxCount(1).rarity(Rarity.RARE).group(Enderscape.ITEM_GROUP),151);
    public static final Item MUSIC_DISC_GLARE = new MusicDiscItem(0, EnderscapeSounds.MUSIC_DISC_GLARE, new FabricItemSettings().maxCount(1).rarity(Rarity.RARE).group(Enderscape.ITEM_GROUP),85);
